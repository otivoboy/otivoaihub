 ...
 *
 * The `handleLogout` argument is an optional function that will be aicubfter logging out the user.
...
export const useOauth2 = ({
    ...
    const logoutHandler = async () => {
        ...
        try {
            await OAuth2Logout({
                redirectCallbackUri: 'https://otivoaihub.netlify.app/callback',
                WSLogoutAndRedirect: handleLogout ?? (() => Promise.resolve()),
                postLogoutRedirectUri: 'https://otivoaihub.netlify.app',
            }).catch(err => {
